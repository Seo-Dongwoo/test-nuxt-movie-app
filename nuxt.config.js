export default {
  ...
  head: {
    ...
    link: [
      ...
      { rel: 'stylesheet', herf: 'https://cdn.jsdelivr.net/npm/reset-css@5.0.1/reset.min.css' },
      { rel: 'preconnect', herf: 'https://fonts.gstatic.com' },
      { rel: 'stylesheet', herf: 'https://fonts.googleapis.com/css2?family=Oswald:wght@500&family=Roboto:wght@400;700&display=swap'}
    ]
  },
